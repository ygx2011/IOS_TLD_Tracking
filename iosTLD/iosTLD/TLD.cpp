...
void TLD::read(/*const FileNode& file*/int MinWin){
  ///Bounding Box Parameters
    min_win = MinWin;//(int)file["min_win"];
  ///Genarator Parameters
  //initial parameters for positive examples
    patch_size = 15;//(int)file["patch_size"];
    num_closest_init = 10;//(int)file["num_closest_init"];
    num_warps_init = 20;//(int)file["num_warps_init"];
    noise_init = 5;//(int)file["noise_init"];
    angle_init = 20;//(float)file["angle_init"];
    shift_init = 0.02;//(float)file["shift_init"];
    scale_init = 0.02;//(float)file["scale_init"];
  //update parameters for positive examples
    num_closest_update = 10;//(int)file["num_closest_update"];
    num_warps_update = 10;//(int)file["num_warps_update"];
    noise_update = 5;//(int)file["noise_update"];
    angle_update = 10;//(float)file["angle_update"];
    shift_update = 0.02;//(float)file["shift_update"];
    scale_update = 0.02;//(float)file["scale_update"];
  //parameters for negative examples
    bad_overlap = 0.2;//(float)file["overlap"];
    bad_patches = 100;//(int)file["num_patches"];
